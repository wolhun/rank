...
export function StorySection() {
  return (
    <section id="how-ai-search-works" className="section-raised section-divider py-20 lg:py-28">
      <div className="section-shell">
        ...
        <div className="mx-auto mt-10 grid max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="card-default rounded-3xl p-5">
            <div className="space-y-2">
              {prompts.map((prompt, i) => (
                <div
                  key={prompt}
                  className={`rounded-xl border border-border bg-background/90 px-4 py-3 text-sm text-foreground ${
                    i % 2 ? "ml-4" : "mr-4"
                  }`}
                >
                  {prompt}
          ...
          <div className="card-muted rounded-3xl p-7">
